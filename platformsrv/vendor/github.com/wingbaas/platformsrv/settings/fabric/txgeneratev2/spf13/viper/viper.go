...
import (
	...
	"github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/spf13/cast"
	jww "github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/spf13/jwalterweatherman"
	"github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/spf13/pflag"
)
...
func (v *Viper) getKeyValueConfig() error {
	if RemoteConfig == nil {
		return RemoteConfigError("Enable the remote features by doing a blank import of the viper/remote package: '_ github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/spf13/viper/remote'")
	}
