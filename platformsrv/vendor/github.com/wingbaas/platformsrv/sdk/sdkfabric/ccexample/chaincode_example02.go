...
func (t *SimpleChaincode) invoke(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("-------get tx invoke info start--------")
	creatorByte,err := stub.GetCreator()
	fmt.Println("tx invoke info=")
   ...
   fmt.Println("-------get tx invoke info end--------")
	...
	if Aval<X {
		return shim.Error("transaction failed, source account have not enough amount")
	}
	Aval = Aval - X
	Bval = Bval + X
	fmt.Printf("Aval = %d, Bval = %d\n", Aval, Bval)
