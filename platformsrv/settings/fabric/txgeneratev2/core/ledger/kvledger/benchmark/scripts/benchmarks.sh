...
# 'BenchmarkInsertTxs' in package 'github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/core/ledger/kvledger/benchmark/experiments'
#
# runReadWriteTxs - This function sets the environment variables and runs the benchmark function
# 'BenchmarkReadWriteTxs' in package 'github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/core/ledger/kvledger/benchmark/experiments'
#
# For the details of test specific parameters, refer to the documentation in 'go' files for the tests
#######################################################################################################

PKG_NAME="github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/core/ledger/kvledger/benchmark/experiments"
