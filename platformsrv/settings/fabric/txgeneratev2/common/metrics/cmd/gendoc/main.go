...
import (
	...
	"github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/common/metrics/gendoc"
...
func main() {
	...
	patterns := flag.Args()
	if len(patterns) == 0 {
		patterns = []string{"github.com/wingbaas/platformsrv/settings/fabric/txgeneratev2/..."}
	}
