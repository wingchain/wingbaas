...
func GenerateLocalMSP(baseDir, name string, sans []string, signCA *ca.CA,
	tlsCA *ca.CA, nodeType int, nodeOUs bool,cryptoType string) error {
	...
	*/
	...
	priv, _, err := csp.GeneratePrivateKey(keystore,cryptoType)
	if err != nil {
		return err
	}
	...
	*/
	...
	// generate private key
	tlsPrivKey, _, err := csp.GeneratePrivateKey(tlsDir,cryptoType)
	if err != nil {
		return err
	}
	// get public key
